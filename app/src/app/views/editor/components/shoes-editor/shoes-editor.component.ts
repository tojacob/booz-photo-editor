...
@Component({
  selector: 'app-shoes-editor',
  templateUrl: './shoes-editor.component.html',
  styleUrls: ['./shoes-editor.component.scss']
})
export class ShoesEditorComponent implements OnInit {
