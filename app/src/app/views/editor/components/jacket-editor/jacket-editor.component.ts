...
@Component({
  selector: 'app-jacket-editor',
  templateUrl: './jacket-editor.component.html',
  styleUrls: ['./jacket-editor.component.scss']
})
export class JacketEditorComponent implements OnInit {
